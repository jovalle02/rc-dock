...
class TabCache {
    ...
    render() {
        ...
        this.cached = cached !== null && cached !== void 0 ? cached : true;
    ...
    render() {
        ...
        for (let [id, tabCache] of this._cache) {
            ...
            items.push({
                ...
                children: (React.createElement(DockTabPane_1.default, { cacheId: id, cached: tabCache.cached, active: isActive, prefixCls: "dock" }, tabCache.tabContent)),
                forceRender: tabCache.cached !== false,
                closable: tabCache.data.closable,
                disabled: false,
            });
        }
        return (React.createElement(tabs_1.default, { prefixCls: "dock", more: { icon: moreIcon }, renderTabBar: this.renderTabBar, activeKey: activeId, onChange: this.onTabChange, popupClassName: (0, classnames_1.default)((0, Utils_1.groupClassNames)(group)), items: items }));
    }
}
